...
class Match(models.Model):
    ...
    home_team = models.ForeignKey(Team, null=True, on_delete=models.CASCADE, related_name='home_matches', db_column='home_team_id')
    away_team = models.ForeignKey(Team, null=True, on_delete=models.CASCADE, related_name='away_matches', db_column='away_team_id')
